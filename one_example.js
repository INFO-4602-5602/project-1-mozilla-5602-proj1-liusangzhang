...
function RadarChart(id, data, options) {
	...
	for(var i = 0; i < data.length; i++) {
		...
		for(var j = 0; j < data[i].length; j++) {
			data[i][j]['value'] = 10 - data[i][j]['value'];
		}
	};
	...
	axisGrid.selectAll(".axisLabel")
	   ...
	   .attr("fill", "#737373")
	   .text(function(d,i) { return Format(10 - maxValue * d/cfg.levels); });
	...
	axis.append("text")
		...
		.attr("y", function(d, i){ return 1.2 * rScale(maxValue * cfg.labelFactor) * Math.sin(angleSlice*i - Math.PI/2); })
